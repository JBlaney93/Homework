...
class TestRoom(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.guests = [self.guest_1, self.guest_2, self.guest_3, self.guest_4, self.guest_5]

    def test_add_multiple_guests_to_room(self):
        self.room_disco.check_in_guests(self.guests)
    ...
    #     self.room_pop.check_in_guest(self.guest_1)
    #     self.room_pop.check_in_guest(self.guest_2)
    #     self.room_pop.check_in_guest(self.guest_3)
